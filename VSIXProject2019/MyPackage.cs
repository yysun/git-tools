...
namespace VSIXProject2019
{
    ...
    [InstalledProductRegistration("Git Tools 2019", "This extension provides a git changes window, and menus to launch Git Bash, Git Extenstions and TortoiseGit.", "3.1.2")]
    ...
    public sealed class MyPackage : AsyncPackage
    {
        ...
        {
            var window = FindToolWindow(typeof(GitChangesWindow), 0, false) as GitChangesWindow;
